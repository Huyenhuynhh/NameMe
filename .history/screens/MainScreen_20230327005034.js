    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.classBox}>
          ...
          <Text style={styles.classDescription}>Introduction to Operating System</Text>
        </View>
        <View style={styles.classBox}>
        ...
        <View style={styles.classBox}>
          ...
          <Text style={styles.classDescription}>Introduction to Programming</Text>
        </View>
        <View style={styles.classBox}>
          <Text style={styles.className}>CMSC 355</Text>
          <Text style={styles.classDescription}>Fundamental of Software Engineering</Text>
        </View>
        <View style={styles.classBox}>
          <Text style={styles.className}>CMSC 401</Text>
          <Text style={styles.classDescription}>Algorithm Analysis and Andvanced Data Structure</Text>
        </View>
      </ScrollView>
