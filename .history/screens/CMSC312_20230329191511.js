...
export default const CMSC312Quiz = ({ navigation }) => {
  ...
  const questions = [
    {
      id: 1,
      question: "Which photo is Justin?",
      options: [
  ...
  const handleFinishButtonPress = () => {
    if (selectedOption === currentQuestion.answer) {
      Alert.alert("Correct!", "You have chosen the right answer.", [
        {
          text: "OK",
          onPress: () =>
            navigation.navigate("QuizResult", { result: "correct" }),
        },
      ]);
    } else {
      Alert.alert("Incorrect!", "You have chosen the wrong answer.", [
        { text: "Try Again", onPress: () => setSelectedOption(null) },
      ]);
    }
  };
    ...
    <View style={styles.container}>
      ...
      >
        <Text style={styles.buttonText}>
          {questionIndex === questions.length - 1 ? "Check" : "Next"}
        </Text>
      </TouchableOpacity>
      <TouchableOpacity
