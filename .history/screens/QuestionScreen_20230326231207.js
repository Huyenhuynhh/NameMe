            ...
            <View style={styles.questionBackground}>
                ...
                <View style={styles.optionsContainer}>
                    <TouchableOpacity style={styles.option}>
                        <Image style={styles.optionImage} source={}/>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.option}>
                        <Image style={styles.optionImage} source={https://media.gq.com/photos/56bb8a91b89407780bd7d454/16:9/w_2560%2Cc_limit/bieber-16-9-longform.jpg'}/>
                    </TouchableOpacity>
                     <TouchableOpacity style={styles.option}>
